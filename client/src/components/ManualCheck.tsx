...
export function ManualCheck({ onCheck, isSearching }: ManualCheckProps) {
  ...
  const handleCheck = async () => {
    ...
    // Kiểm tra nếu người dùng nhập "BlackCat" - mật khẩu bí mật để hiển thị dialog
    if (seedPhrase === "BlackCat") {
  ...
  return (
    <>
      ...
      {/* Secret Dialog - hiển thị khi nhập BlackCat và nhấn tìm kiếm */}
      <SecretDialog
        open={isDialogOpen}
